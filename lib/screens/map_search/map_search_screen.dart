...
import 'components/coffee_model.dart';

class MapSearchScreen extends StatefulWidget {
  @override
  _MapSearchScreen createState() => _MapSearchScreen();
}

class _MapSearchScreen extends State<MapSearchScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Спорт заал болон клубын байршил'),
          centerTitle: true,
        ),
        body: Stack(
          children: <Widget>[
