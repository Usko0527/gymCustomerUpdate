...
class TennisBody extends StatefulWidget {
  @override
  _TennisBody createState() => _TennisBody();
}

class _TennisBody extends State<TennisBody> {
  ...
  void initState() {
    ...
    ref.child('gymInformation').once().then((DataSnapshot snap) {
      ...
      values.forEach((key, values) {
        if ((values['tennis'] != null && values['tennis'] == 1)) {
          imagesUrl = [];
