...
class BowlingBody extends StatefulWidget {
  @override
  _BowlingBody createState() => _BowlingBody();
}

class _BowlingBody extends State<BowlingBody> {
  ...
  void initState() {
    ...
    ref.child('gymInformation').once().then((DataSnapshot snap) {
      ...
      values.forEach((key, values) {
        if ((values['bowling'] != null && values['bowling'] == 1) ||
            (values['billard'] != null && values['billard'] == 1)) {
          imagesUrl = [];
